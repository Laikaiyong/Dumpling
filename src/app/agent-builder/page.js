        ...
        <motion.div
          ...
          style={{
            ...
            transform: `translateX(${Math.max(
              250 - ((index * 13) % 90) * (windowSize.width / 100),
              0
            )}px)`,
      ...
      <div className="flex min-h-screen pt-16">
        ...
        <div className="flex-1 p-6">
          ...
          <motion.div
            ...
            <Link href="/create" aria-label="Create new agent">
              <motion.button
                className="bg-gradient-to-r from-[#ff3131] to-[#ffcc00] text-black font-bold py-4 px-6 rounded-full flex items-center gap-2 shadow-lg"
                whileHover={{
                  scale: 1.05,
          ...
          <motion.div
            ...
            <p className="text-gray-400 max-w-2xl ml-2">
              Choose a template to get started or create a custom agent from
              scratch. Each template comes with pre-configured capabilities.
            </p>
          ...
          <div className="mb-8 relative">
            <div className="relative">
              ...
              <motion.div
                ...
                style={{
                  backgroundImage:
                    "url('https://ae01.alicdn.com/kf/S1d46c80508cc4728804c6fa2ad1f39aeb.png')",
                  backgroundSize: "contain",
          ...
          <motion.div
            ...
            <div className="flex items-center mb-4">
              ...
              <motion.div
                ...
                style={{
                  backgroundImage:
                    "url('https://static.vecteezy.com/system/resources/thumbnails/012/634/568/small_2x/red-acrylic-paint-strokes-for-design-elements-artistic-brush-strokes-for-ornament-and-lower-thirds-isolated-background-png.png')",
                ...
                {filteredAgents.map((agent, index) => (
                  <motion.div
                    ...
                    <motion.div
                      ...
                      <svg
                        viewBox="0 0 100 100"
                        className="w-full h-full text-[#ff3131]/10">
                    ...
                    <div className="flex items-start mb-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#ff3131]/10 to-[#ffcc00]/10 rounded-lg flex items-center justify-center text-2xl mr-4">
                        {categoryIcons[agent.type?.toLowerCase()] || "🤖"}
                      </div>
                      <div>
          ...
          <motion.div
            ...
            <motion.div
              ...
              style={{
                background:
                  "url('https://images.vexels.com/media/users/3/282629/isolated/preview/5b4f6600ccbdb881f8870f02419820ec-chinese-new-year-dragon-zodiac-sign.png')",
                backgroundSize: "contain",
            ...
            <div className="flex flex-col md:flex-row items-center justify-between relative z-10">
              <div>
                ...
                <p className="text-gray-400">
                  Build a custom agent with exactly the capabilities you want.
                </p>
              </div>
              <Link href="/create">
                <motion.button
